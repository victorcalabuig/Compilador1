...
{
    DECLARE, ASIGN, PRINT, IF, ELSE, WHILE,
...
{
    m_token = token;
    add(newCommand(Action.ASIGN, Type.VOID, null));
}
...
//------------------------------------------------------------------------
private RunCommand newRunAsignacion() { return c ->
{
    Node n2 = stackPop(),
         n1 = stackPop();
...
//------------------------------------------------------------------------
private RunCommand newRunImprimir() { return c ->
{
...
//------------------------------------------------------------------------
private RunCommand newRunConstante() {return c ->
{
    stackPush(c.type, c.value);
    return c.next;
};}
...
//------------------------------------------------------------------------
private RunCommand newRunSumar() {return c ->
{
    Node n2 = stackPop(),
         n1 = stackPop();
...
//------------------------------------------------------------------------
private RunCommand newRunRestar() {return c ->
{
    Node n2 = stackPop(),
         n1 = stackPop();
...
//------------------------------------------------------------------------
private RunCommand newRunNegar() {return c ->
{
    Node n = stackPop();
...
//------------------------------------------------------------------------
private RunCommand newRunMultiplicar() {return c ->
{
    Node n2 = stackPop(),
         n1 = stackPop();
...
//------------------------------------------------------------------------
private RunCommand newRunDividir() {return c -> {
    Node n2 = stackPop(),
         n1 = stackPop();
...
//------------------------------------------------------------------------
private RunCommand newRunIgual() {return c ->
{
    Node n2 = stackPop(),
         n1 = stackPop();
...
//------------------------------------------------------------------------
private RunCommand newRunDistinto() {return c -> {
    Node n2 = stackPop(),
         n1 = stackPop();
...
//------------------------------------------------------------------------
private RunCommand newRunMenor() {return c ->
{
    Node n2 = stackPop(),
         n1 = stackPop();
...
//------------------------------------------------------------------------
private RunCommand newRunMenorIgual() {return c -> {
    Node n2 = stackPop(),
         n1 = stackPop();
...
//------------------------------------------------------------------------
private RunCommand newRunMayor() {return c ->
{
    Node n2 = stackPop(),
         n1 = stackPop();
...
//------------------------------------------------------------------------
private RunCommand newRunMayorIgual() {return c ->
{
    Node n2 = stackPop(),
         n1 = stackPop();
...
private void inicializarRun()
{
    ...
    m_run[Action.ASIGN .ordinal()] = newRunAsignacion();
    m_run[Action.PRINT   .ordinal()] = newRunImprimir();
    ...
    m_run[Action.CONSTANT  .ordinal()] = newRunConstante();
    m_run[Action.ADD      .ordinal()] = newRunSumar();
    m_run[Action.SUBTRACT     .ordinal()] = newRunRestar();
    m_run[Action.NEGATE      .ordinal()] = newRunNegar();
    m_run[Action.MULTIPLY.ordinal()] = newRunMultiplicar();
    m_run[Action.DIVIDE    .ordinal()] = newRunDividir();
    m_run[Action.EQUAL      .ordinal()] = newRunIgual();
    m_run[Action.UNEQUAL   .ordinal()] = newRunDistinto();
    m_run[Action.LESS      .ordinal()] = newRunMenor();
    m_run[Action.LESSEQ .ordinal()] = newRunMenorIgual();
    m_run[Action.GREATER      .ordinal()] = newRunMayor();
    m_run[Action.GREATEREQ .ordinal()] = newRunMayorIgual();
